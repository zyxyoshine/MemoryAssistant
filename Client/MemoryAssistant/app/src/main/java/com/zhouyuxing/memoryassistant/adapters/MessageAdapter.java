package com.zhouyuxing.memoryassistant.adapters;
...
import com.zhouyuxing.memoryassistant.R;
        ...
        public void bindMessage(JSONObject jsonObject) {
            if (jsonObject != null) {
                try {
                    ...
                    String ti = jsonObject.getString("time");
                    Spannable spannableUser = new SpannableString(type == VIEW_TYPE_SEND_MESSAGE ? "<" + ti +"> 你:\n": "<" + ti +"> " + (String)jsonObject.get("username") + ":\n");
